...
`;
  ...
  it("should accept scripts with curl|bash (used by jelma scripts)", () => {
...
`;
  ...
  it("should accept scripts with wget|bash (used by jelma scripts)", () => {
...
`;
  ...
  it("should accept curl|bash with tabs (used by jelma scripts)", () => {
