...
#   curl -fsSL --proto '=https' https://raw.githubusercontent.com/neosantara-xyz/jelma/neosantara/sh/shared/github-auth.sh | bash
#   curl -fsSL --proto '=https' https://raw.githubusercontent.com/neosantara-xyz/jelma/neosantara/sh/shared/github-auth.sh | bash
#
# Usage (sourced using absolute path or CDN URL):
#   eval "$(curl -fsSL --proto '=https' https://raw.githubusercontent.com/neosantara-xyz/jelma/neosantara/sh/shared/github-auth.sh)"
#   ensure_github_auth
